			...
			<div class="content">
				...
				<div class="section" id="advanced_settings">
					...
					<p>
						...
						if (form_error('set_checkbox')('display_branding', 'y'))
						{
							echo form_error('set_checkbox')('display_branding', 'y');
						}
					...
					<p>
						...
						if (form_error('set_checkbox')('new_version_autocheck', 'y'))
						{
					...
					<p>
						...
						if (form_error('set_checkbox')('save_invoices', 'y'))
						{
							echo form_error('set_checkbox')('save_invoices', 'y');
						}
